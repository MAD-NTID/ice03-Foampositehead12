...
//August 30,2019
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int credit = 17;
            string program = "Program Fund";
            string myFirstName = "Asido";
            string myLastName = "Yellow-Duke"; 

            Console.WriteLine("Hola, My name is "+ myFirstName + " "+ myLastName +".I'm "+age+"years old.\n"); 
            ...
            Console.WriteLine("\nSo, now I'm a student here at RIT/NTID. I'm in the "+ program +", taking "+ credit +" credits"+"."+" That's pretty crazy for someone who was born in "+year+".\n");
